...
const eventLabels: Record<string, string> = {
  ...
  bid_excluded: "Offerta esclusa",
  bid_withdrawn: "Offerta ritirata",
  onboarding_completed: "Onboarding completato",
  change_request_submitted: "Richiesta modifica anagrafica",
  ...
  supplier_suspended_expired_docs: "Account sospeso per documenti scaduti",
  pre_registration: "Richiesta di accesso",
  accreditation_approved: "Accreditamento approvato",
  supplier_accredited: "Accreditamento confermato",
  supplier_in_accreditation: "Accreditamento in corso",
  supplier_pending_review: "In attesa di revisione",
  purchase_request_submitted: "Nuova richiesta di acquisto",
  purchase_request_approved: "Richiesta approvata",
  purchase_request_rejected: "Richiesta respinta",
  purchase_request_needs_finance: "Richiesta sopra soglia",
  purchase_request_ready_for_purchase: "Richiesta autorizzata",
};
